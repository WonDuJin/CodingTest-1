...
const score_analysis1=(teamName: string,playDate: string,playerName: string,totalScore: number,threepoint: number,freedrawChance: number): void=>{  
  //type을 지정해 주었는데 왜 syntax error가 뜨는지 모르겠음 ㅠㅠ
...
score_analysis1("KDT","11월11일","공미남",84,16,38)
